...
const ProfilePage = () => {
  ...
  return (
    <div className="h-screen pt-20 bg-gray-100">
      <div className="max-w-2xl mx-auto p-4 py-8 bg-white shadow-md rounded-lg">
        <div className="bg-white rounded-xl p-6 space-y-8">
          ...
          <div className="space-y-6">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-gray-100 rounded-lg border border-gray-300 text-black">{authUser?.fullName}</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-gray-100 rounded-lg border border-gray-300 text-black">{authUser?.email}</p>
            </div>
          </div>
          ...
          {/* <div className="mt-6 bg-white rounded-xl p-6 shadow-sm"> */}
            ...
            {/* <div className="space-y-3 text-sm"> */}
              {/* <div className="flex items-center justify-between py-2 border-b border-gray-300 text-black">
